...
export function QuotesPair() {
  return (
    <section className="bg-white px-6 md:px-10 lg:px-12 2xl:px-20 py-16 lg:py-20 2xl:py-28">
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-14 2xl:gap-20">
        <div className="flex-1">
          <div className="flex items-start gap-6 lg:gap-8 2xl:gap-10">
            ...
            <div>
              <p className="text-[#3E3E3E] text-lg lg:text-[21px] 2xl:text-[25px] font-medium leading-[1.2]">
