...
export function ProjectHero() {
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-dark">
      ...
      <div className="relative z-10 flex flex-col justify-between min-h-screen px-6 md:px-10 lg:px-12 2xl:px-20">
        <ScrollReveal variant="fade-down" delay={300} duration={1000}>
          <div className="pt-[240px] lg:pt-[50px] max-w-[324px]">
            <p className="text-white font-bold text-sm lg:text-lg 2xl:text-xl leading-[1.2] mb-3 lg:mb-4">
              &ldquo;If you behave badly in this life, you&rsquo;ll become a Chilean in the next.&rdquo;
            </p>
            <p className="text-white font-bold text-xl lg:text-[22px] 2xl:text-[28px] leading-none mb-0.5 lg:mb-1">
              Raul Ruiz
            </p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-10 2xl:gap-16 pb-12 lg:pb-14 2xl:pb-20">
          <ScrollReveal variant="fade-up" delay={500} duration={1100}>
            <h1 className="text-white text-[40px] sm:text-[60px] lg:text-[66px] 2xl:text-[90px] font-bold leading-[0.9] tracking-[0.01em]">
