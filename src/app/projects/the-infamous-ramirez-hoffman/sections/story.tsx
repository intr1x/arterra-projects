  ...
  return (
    <section className="bg-white px-6 md:px-10 lg:px-20 py-12 lg:py-20">
      ...
      <ScrollReveal variant="fade-up" duration={900}>
        <div className="flex gap-6 lg:gap-10 items-start lg:pl-[130px] lg:pr-[270px]">
          ...
          <div className="max-w-[1034px]">
            <div className="text-[#3E3E3E] text-lg lg:text-[25px] font-medium leading-[1.26] text-justify space-y-4">
              <p>
            ...
            <p className="text-[#9A7145] font-bold text-lg lg:text-[21px] leading-none mt-6">
              John Malkovich
            </p>
          </div>
        </div>
